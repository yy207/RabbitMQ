...
[原文](https://github.com/suxiongwei/springboot-rabbitmq)
...
## 消费端配置
    listener:
      simple:
        ...
        prefetch: 1
  datasource:
      url: jdbc:mysql://localhost:3306/useUnicode=true&characterEncoding=utf-8&zeroDateTimeBehavior=convertToNull
      username: root
      password: root
      driverClassName: com.mysql.jdbc.Driver
server:
